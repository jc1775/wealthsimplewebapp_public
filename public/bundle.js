(function() {
    ...
    }, { "./lib/edge": 2, "./lib/point": 3, "./lib/polygon": 4, "./lib/polygonArray": 5 }],
    ...
    5: [function(require, module, exports) {
        ...
        class PolygonArray {
            ...
            getResult() {
                ...
                return (points.length > 1 && this.getLast().getPoints().length) ? points : [].concat(...points);
            }
        }
    ...
    6: [function(require, module, exports) {
        ...
        chart.config.options.onHover = (e) => {
            ...
            intersectObj = polygonsIntersect(poly1, poly2)
            var yIntersect = 0
            intersectObj.forEach(point => {
                if (point.y > yIntersect) {
                    yIntersect = point.y
                }
            });
